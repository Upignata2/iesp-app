...
export default function Home() {
    ...
    return (_jsxs("div", { className: "min-h-screen pb-24 bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-900 relative", children: [isAuthenticated && _jsx(Button, { className: "absolute top-4 right-4 text-white", variant: "ghost", onClick: logout, children: "Sair" }), _jsx("div", { className: "mx-4 mt-8 text-center text-white", children: _jsx("div", { className: "text-5xl font-bold tracking-wide", children: "IESP" }) }), _jsx("div", { children: _jsxs("div", { className: "max-w-6xl mx-auto px-4 py-6", children: [!isAuthenticated ? (_jsxs("div", { className: "text-center mb-6", children: [_jsx(Button, { size: "lg", className: "bg-[#D2D7DB] text-blue-700", onClick: () => navigate('/login'), children: "Login" }), _jsx("div", { className: "mt-3", children: _jsx(Button, { variant: "ghost", onClick: () => navigate('/'), children: "Continuar sem login" }) })] })) : (_jsxs("div", { className: "hidden", children: [] })), _jsx("div", { className: "grid grid-cols-3 gap-4", children: menuItems.map((item) => {
                                const Icon = item.icon;
                                return (_jsxs("button", { onClick: () => handleClick(item.route), className: "group flex flex-col items-center gap-3 transition-transform hover:scale-105", children: [_jsx("div", { className: "w-16 h-16 rounded-2xl flex items-center justify-center bg-[#0b0f1a]/40 ring-1 ring-[#1f2937] text-white shadow-lg", children: _jsx(Icon, { className: "w-7 h-7" }) }), _jsx("span", { className: "text-xs text-white/80", children: item.label })] }, item.id));
                            }) })] }) })] }));
}
